...
public class DatosNoValidosException extends java.lang.Exception {
    private static final long serialVersionUID = 1564511259136L;
    private es.unican.ss.seguros.DatosNoValidos faultMessage;
    ...
    public void setFaultMessage(es.unican.ss.seguros.DatosNoValidos msg) {
        faultMessage = msg;
    }

    public es.unican.ss.seguros.DatosNoValidos getFaultMessage() {
        return faultMessage;
    }
}
